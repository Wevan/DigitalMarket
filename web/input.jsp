                            ...
                            <div class="forms">
                                <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                    ...
                                    <%--<form action="/upload.action" method="post" enctype="multipart/form-data">--%>
                                        <%--<input type="text" class="form-control" placeholder="商品名称" name="product.pname">--%>
                                        <%--<input type="text" class="form-control" placeholder="商品简介" name="product.desc">--%>
                                        <%--<input type="text" class="form-control" placeholder="单价" name="product.price">--%>
                                        <%--<input value="${sessionScope.user.id}" style="display: none" name="product.sid">--%>
                                    ...
                                    <div class="form-body">
                                        ...
                                        <form action="/upload.action" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="商品名称" name="product.pname">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">简介</label>
                                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="商品简介" name="product.desc">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="库存" name="product.totalNum">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputFile">商品预览图</label>
                                                <input type="file" id="exampleInputFile" name="uploadImage">
                                            </div>
                                            <button type="submit" class="btn btn-default">提交</button>
                                        </form>
