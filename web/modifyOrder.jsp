                                        ...
                                        <form action="/modifyOrder.action" method="post">
                                            <div class="form-group" style="display: none">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                       value="<%=request.getParameter("id")%>" name="order.id">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">收货人</label>
                                                <input type="text" class="form-control" id="exampleInputPassword1"
                                                       value="<%=request.getParameter("bname")%>" name="order.bname">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">收货电话</label>
                                                <input type="text" class="form-control" value="<%=request.getParameter("phone")%>"
                                                       name="order.phone">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">收货地址</label>
                                                <input type="text" class="form-control" value="<%=request.getParameter("addr")%>"
                                                       name="order.addr">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">留言信息</label>
                                                <input type="text" class="form-control" value="<%=request.getParameter("note")%>"
                                                       name="order.note">
                                            </div>
