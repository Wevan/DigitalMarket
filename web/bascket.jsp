                ...
                <div class="women_main">
                    ...
                    <div class="check">
                        <div class="col-md-3 cart-total">
                            <%
                                ArrayList<Bascket> listBckt = (ArrayList<Bascket>) ActionContext.getContext().getSession().get("listBsk");
                                System.out.println("Bascket jsp getlist "+listBckt.size());
                                double price=0.0;
                                for (int i = 0; i < listBckt.size(); i++) {
                                    price+=listBckt.get(i).getPrice();
                                }
                            %>
                            ...
                            <div class="price-details">
                                <h3>价格详情</h3>
                                <span>商品数量</span>
                                <span class="total1"><%=listBckt.size()%></span>
                                <span>折扣</span>
                                <span class="total1">---</span>
                                <span>运费</span>
                                <span class="total1">6.00</span>
                                <div class="clearfix"></div>
                            </div>
                            <ul class="total_price">
                                <li class="last_price"><h4>总价</h4></li>
                                <li class="last_price"><span><%=price+6.00*listBckt.size()%></span></li>
                                <div class="clearfix"></div>
                            </ul>
                                ...
                                <div class="cart-sec simpleCart_shelfItem">
                                    ...
                                    <div class="cart-item-info">
                                        <h3><a href="#"><%=bascket.getPname()%></a>
                                            <span>商品号 ： <%=bascket.getId()%></span></h3>
                                        <ul class="qty">
                                            <li><p>Size : 5</p></li>
                                            <li><p>Qty : 1</p></li>
                                        </ul>
                                        ...
                                        <div class="delivery">
                                            <p>单价 : <%=bascket.getPrice()%></p>
                                            <span>物流时间约为 3-5 天</span>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
