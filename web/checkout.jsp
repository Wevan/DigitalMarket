                    ...
                    <div class="check">
                        <div class="col-md-3 cart-total">
                            ...
                            <div class="price-details">
                                <h3>价格详情</h3>
                                <span>商品</span>
                                <span class="total1"><%=product.getPrice()%></span>
                                <span>折扣</span>
                            ...
                            <ul class="total_price">
                                ...
                                <li class="last_price"><span><%=product.getPrice()+6.00%></span></li>
                                <div class="clearfix"></div>
                            </ul>
                            ...
                            <div class="cart-header">
                                ...
                                <div class="cart-sec simpleCart_shelfItem">
                                    ...
                                    <div class="cart-item-info">
                                        <h3><a href="#"><%=product.getPname()%></a>
                                            <span>商品号 ： <%=product.getId()%></span></h3>
                                        <ul class="qty">
                                            <li><p>Size : 5</p></li>
                                            <li><p>Qty : 1</p></li>
                                        </ul>
